...
import { Post, ContentChild } from '../service/model';
...
const PostDetail: React.FC<PostDetailProps> = ({ post }) => {
  const getContentFragment = (index: number, text: React.ReactNode[], obj: ContentChild, type: string) => {
      ...
      <div className="bg-white shadow-lg rounded-lg lg:p-8 pb-12 mb-8">
        ...
        <div className="px-4 lg:px-0">
          ...
          {post.content.raw.children.map((typeObj, index) => {
            ...
            return getContentFragment(index, children, typeObj.children[0], typeObj.type);
          })}
        </div>
      </div>
    </>
